...
let marker39=document.getElementById('animated-marker39')
let marker25=document.getElementById('animated-marker25')
...
marker12.addEventListener("markerFound", (e)=>{ 
    ...
    let vid=document.getElementById("dust")
    vid.play();
...
marker12.addEventListener("markerLost",(e) => {
    let vid=document.getElementById("dust")
    vid.pause();
});

marker25.addEventListener("markerFound", (e)=>{ 

    let vid=document.getElementById("water-tank")
    vid.play();
...
marker25.addEventListener("markerLost",(e) => {
    let vid=document.getElementById("water-tank")
    vid.pause();
});